...
def turtle_twist(linear_velocity, angular_velocity):
    ...
    """
    return Twist(linear = Vector3(x = linear_velocity[0], y = linear_velocity[1], z = linear_velocity[2]),
                    angular = Vector3(x = angular_velocity[0], y = angular_velocity[1], z = angular_velocity[2]))
...
class Turtle_Robot(Node):
    ...
    def __init__(self):
        ...
        self.turtlesim_pose_subscriber = self.create_subscription(Pose,'/turtle1/pose',self.turtlesim_pose_callback, 1)
        ...
        self.goal_pose_subscriber = self.create_subscription(PoseStamped, 'goal_pose', self.goal_pose_callback, 1)
